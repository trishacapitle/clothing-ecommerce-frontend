...
const Hero = () => {
  return (
    <section className="sm:flex-center col-center relative w-full bg-[#F2F0F1] lg:h-[660px]">
      <img
        src={bg}
        alt="hero image"
      ...
      <div className="content flex-center z-50 h-full gap-24 px-4 sm:w-[80dvw] sm:px-0">
        <div className="mt-10 flex flex-1/2 flex-col gap-5 sm:mt-0 lg:gap-8">
        ...
        <div className="relative hidden h-full flex-1/2 md:inline-block">
          <img
            src={vector}
            alt="vector image"
